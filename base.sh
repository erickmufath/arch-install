...
#Pacstrap
pacstrap /mnt base base-devel linux linux-firmware linux-headers nano sudo packagekit-qt5 dbus archlinux-keyring wget git libnewt ntfsprogs ntfs-3g dosfstools dos2unix e2fsprogs xfsprogs btrfs-progs --noconfirm --needed
